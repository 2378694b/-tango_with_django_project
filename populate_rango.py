...
def populate():
    ...
    django_pages = [
        ...
        {'title':'How to Tango with Django','url':'http://www.tangowithdjango.com/', 'views': 256} ]
        
    other_pages = [
        {'title':'Bottle','url':'http://bottlepy.org/docs/dev/', 'views': 512},
        {'title':'Flask','url':'http://flask.pocoo.org', 'views': 1024} ]
